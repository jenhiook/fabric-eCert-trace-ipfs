<template>
  <div class="trace-container">
    ...
    <el-button type="success" plain @click="AllFruitInfo"> 获取所有电子证照信息 </el-button>
    <el-table
      :data="tracedata"
      style="width: 100%"
    >
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <div><span class="trace-text" style="color: #67C23A;">电子证照信息</span></div>
            <el-form-item label="电子证照类型：">
            ...
            <div><span class="trace-text" style="color: #409EFF;">政务部门信息</span></div>
            ...
            <div><span class="trace-text" style="color: #E6A23C;">企业组织</span></div>
            ...
            <div><span class="trace-text" style="color: #909399;">技术支撑实体信息</span></div>
