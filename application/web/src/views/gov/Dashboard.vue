<template>
  <div class="dashboard-container">
    <h2 class="title">政府端证照统计分析（全局证照）</h2>
...
import { govGetStats } from '@/api/gov'
...
export default {
  ...
  computed: {
    statCards() {
      return [
        { title: '证照总数', value: this.stats.totalCerts, icon: 'el-icon-document' },
